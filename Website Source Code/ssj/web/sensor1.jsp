...
div {
    ...
    <center>
        ...
        %>
        <div>USER-1 SARATH SENSOR DATA</div>
       <%
              ...
              try
      {
        ...
        ResultSet rs =stmt.executeQuery("select *from iot_update where Num=1");
              ...
              float $cal =Float.parseFloat(rs.getString("MotionAxisX"));
                   if($cal >= 1 && $cal <=30)
                   
                    {
                     ...
                     out.println("<img src='x9.png' alt='image' width=100 height =100 />");
                    }
